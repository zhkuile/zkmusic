...
package com.karsteon.zkmusic.slice;

import com.karsteon.zkmusic.ResourceTable;
import com.karsteon.zkmusic.utils.LogUtil;
import com.karsteon.zkmusic.utils.PlayerManager;
import com.karsteon.zkmusic.utils.PlayerStateListener;
 ...
 * main ability slice
 */
public class MainMusicAbilitySlice extends AbilitySlice implements PlayerStateListener, IAbilityContinuation {
    private static final String TAG = MainMusicAbilitySlice.class.getSimpleName();
    ...
    private static final String CONTINUE_BUNDLE = "com.karsteon.zkmusic";
    ...
    private void initContinuationRegisterManager() {
        ...
        jsonParams = "{'filter':{'commonFilter':{'groupType':'1|256','faFilter':'{\"targetBundleName\":\"com.karsteon.zkmusic\"}'}}}";
